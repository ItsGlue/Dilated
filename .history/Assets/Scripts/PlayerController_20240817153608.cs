...
public class PlayerMovement : MonoBehaviour
{
    ...
    private Vector3 previousScale = new Vector3(1.3f, 1.3f, 1f);
    private bool landingEffectTriggered = false; // Added to debounce landing effect
    ...
    private void Update()
    {
        ...
        if (isGrounded)
        {
            ...
            landingEffectTriggered = false; // Reset landing effect trigger
        }
        else
        {
    ...
    {
        if (IsGrounded() && !landingEffectTriggered)
        {
            SquashStretchEffect("land");
            landingEffectTriggered = true; // Set to true to prevent repeated triggering
